...
public class APSCalculator {
    ...
    private Map<String, String[]> student_subjects_info;

    public APSCalculator() {
    }

    public APSCalculator(Map<String, String[]> student_subjects_info) {
        this.student_subjects_info = student_subjects_info;
    }

    public void set_student_subjects_info(Map<String, String[]> student_subjects_info) {
        this.student_subjects_info = student_subjects_info;
    }
    ...
    // Sorts elective marks from highest to lowest because 3 highest elective subjects will be used to calsulate APS
